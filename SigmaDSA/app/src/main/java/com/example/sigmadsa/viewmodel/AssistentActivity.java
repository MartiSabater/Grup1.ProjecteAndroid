...
public class AssistentActivity extends AppCompatActivity {
    ...
    private void askAssistent() {
        ...
        AssistentRequest request = new AssistentRequest(question);

        apiService.askAssistent(request).enqueue(new Callback<AssistentResponse>() {
            @Override
            ...
            public void onFailure(Call<AssistentResponse> call, Throwable t) {
                ...
                Toast.makeText(AssistentActivity.this, "Error de red: " + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
}